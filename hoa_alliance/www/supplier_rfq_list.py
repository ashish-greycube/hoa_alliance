...
def get_context(context):
	...
	if (user != 'Guest' and is_website_user()) or doctype == 'Request for Quotation':
		...
		if doctype == 'Request for Quotation':
			...
			RFQ.company as company, usercf.full_name as requester ,RFQ.transaction_date as requested_date,RFQ.required_by_due_date_cf as required_date FROM `tabRequest for Quotation` RFQ
